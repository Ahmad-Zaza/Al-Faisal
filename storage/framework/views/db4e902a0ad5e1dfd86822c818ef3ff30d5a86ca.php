...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset($settings['favicon'])); ?>" type="image/png" sizes="16x16">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('img/al-faisal-logo.jpg')); ?>">
    ...
    <!-- Vendor CSS Files -->
    <link href="<?php echo e(asset('css/aos/aos.css')); ?>" rel="stylesheet">
    ...
    <?php if($lang == 'ar'): ?>
        ...
        <link href="<?php echo e(asset('css/style-rtl.css')); ?>" rel="stylesheet" type="text/css" media="all" />
    <?php endif; ?>
...
<body lang="<?php echo e($lang); ?>">
        ...
        <header id="header" class="fixed-top d-flex align-items-center">
            <nav id="navbar" class="navbar navbar-expand-lg">
                <div class="container-fluid navbar-container">
                    <a class="navbar-brand navbar-right" href="<?php echo e(route('home')); ?>">
                        <img class="companyLogo" alt="CompanyLogo" src="<?php echo e(asset('img/al-faisal-logo.jpg')); ?>"
                            loading="lazy">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $main_menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <?php if($main_menu->is_download_menu == 1): ?>
                                    <li class="nav-item main-nav-item" id="drop-down-nav">
                                        <a id="nav-item" class="nav-link" href="<?php echo e(route('our_menu')); ?>"
                                            target="_blank">
                                            <?php echo e($main_menu["name_$lang"]); ?><i class="fa fa-download downolad-nav-item"
                                                aria-hidden="true"></i>
                                        </a>
                                    </li>
                                <?php elseif($main_menu->is_drop_down_menu == 1): ?>
                                    <li id="drop-down-nav"
                                        class="nav-item dropdown nav-dropdown-menu main-nav-item <?php echo e(Request::fullUrl() == $href ? 'color-li' : ''); ?>">
                                        <a id="drop-down-nav-link"
                                            class="nav-link  dropdown-toggle <?php echo e(Request::fullUrl() == $href ? 'active-nav-link' : ''); ?> <?php echo e(Route::currentRouteName() == 'category_menu.index' ? 'active-nav-link' : ''); ?>"
                                            href="<?php echo e(route('service_events.index')); ?>" data-bs-toggle="dropdown">
                                            <?php echo e($main_menu["name_$lang"]); ?></a>
                                        <ul class="dropdown-menu">
                                            <?php $__currentLoopData = $catering_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catering_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><a class="dropdown-item"
                                                        href="<?php echo e(route('category_menu.index', [$catering_category['id']])); ?>"><?php echo e($catering_category["name_$lang"]); ?></a>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                        <div
                                            class="overlay-nav-item <?php echo e(Request::fullUrl() == $href ? 'active-overlay-nav-item' : ''); ?> <?php echo e(Route::currentRouteName() == 'category_menu.index' ? 'active-overlay-nav-item' : ''); ?>">

                                        </div>
                                    </li>
                                <?php else: ?>
                                    <li class="nav-item main-nav-item ">
                                        <div class="overlay <?php echo e(Request::fullUrl() == $href ? 'color-li' : ''); ?>">
                                            <a id="nav-item"
                                                class="nav-link <?php echo e(Request::fullUrl() == $href ? 'active-nav-link' : ''); ?>"
                                                href="<?php echo e($href); ?>">
                                                <?php echo e($main_menu["name_$lang"]); ?>

                                            </a>
                                        </div>
                                        <div
                                            class="overlay-nav-item <?php echo e(Request::fullUrl() == $href ? 'active-overlay-nav-item' : ''); ?>">
                                        </div>
                                    </li>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="navbar-nav lang-nav-ul">
                            <li class="nav-item active-lang-en">
                                <a id="nav-item" class="nav-link" href="<?php echo e(route('change_lang', ['en'])); ?>"
                                    style="color:#ffffff ;"><?php echo e(__('en_lang')); ?></a>
                            </li>
                            <li class="nav-item active-lang-ar">
                                <a id="nav-item" class="nav-link"
                                    href="<?php echo e(route('change_lang', ['ar'])); ?>"><?php echo e(__('ar_lang')); ?></a>
                            </li>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/aos.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('css/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
