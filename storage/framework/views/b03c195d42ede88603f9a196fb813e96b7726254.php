...
?>
<?php if(file_exists(base_path('/vendor/crocodicstudio_voila/crudbooster/src/views/default/type_components/'.$type.'/asset.blade.php'))): ?>
...
?>
<?php if(file_exists(base_path('/vendor/crocodicstudio_voila/crudbooster/src/views/default/type_components/'.$type.'/component.blade.php'))): ?>
