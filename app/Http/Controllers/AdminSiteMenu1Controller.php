<?php namespace App\Http\Controllers;
	...
	class AdminSiteMenu1Controller extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Section","name"=>"section"];
			...
			$this->form[] = ['label'=>'Section','name'=>'section','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Is Download Menu','name'=>'is_download_menu','type'=>'select','validation'=>'required','width'=>'col-sm-9','dataenum'=>'1|Yes;0|No'];
			$this->form[] = ['label'=>'Is Drop Down Menu','name'=>'is_drop_down_menu','type'=>'select','validation'=>'required','width'=>'col-sm-9','dataenum'=>'1|Yes;0|No'];
			$this->form[] = ['label'=>'Active','name'=>'active','type'=>'select','validation'=>'required','width'=>'col-sm-9','dataenum'=>'1|Yes;0|No'];
