...
use App\Http\Models\MenuRecipeItem;
use Carbon\Carbon;
...
class AdminCategoryMenuController extends \crocodicstudio_voila\crudbooster\controllers\CBController
{
	protected $recipes_ar = array();
	protected $recipes_en = array();
	...
	public function cbInit()
	{
			...
			$this->col[] = ["label"=>"Category","name"=>"category_id","join"=>"categories,name_ar"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name Ar','name'=>'name_ar','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Name En','name'=>'name_en','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Category Id','name'=>'category_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'categories,name_ar'];
			$this->form[] = ['label'=>'Recipe Ar','name'=>'recipes_ar','type'=>'multitext','validation'=>'required','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Recipe En','name'=>'recipes_en','type'=>'multitext','validation'=>'required','width'=>'col-sm-9'];
		...
		// $this->index_button[] = ['label' => 'Set SEO', 'title' => 'seo', 'url' => HelpersCRUDBooster::adminPath('seo/category-menu'), "icon" => "fa fa-globe"];
