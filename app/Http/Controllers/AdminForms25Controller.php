<?php namespace App\Http\Controllers;
	...
	class AdminForms25Controller extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Row Type","name"=>"row_type"];
			...
			$this->form[] = ['label'=>'Send To','name'=>'send_to','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Row Type','name'=>'row_type','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Sorting','name'=>'sorting','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
